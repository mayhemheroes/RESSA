...
## Run Information
- Mayhem Run: mayhemheroes/ressa/ressa-fuzz/1
- Git Commit: 58806aee2ab2df5a7d7ec5daf32112e700affc7a
- Original Image: ghcr.io/mayhemheroes/ressa:master
- CI URL: https://github.com:443/mayhemheroes/RESSA//actions/runs/3768068198
...
- `rlenv/source/ressa/` - Source code (build from this location)
...
3. **Extract build steps**: Move build commands to `rlenv/mayhem/data/scripts/build.sh` that builds from `/rlenv/source/ressa/`
...
- Source code should be at `/rlenv/source/ressa/` in the container
- Build script should work from `/rlenv/source/ressa/`
